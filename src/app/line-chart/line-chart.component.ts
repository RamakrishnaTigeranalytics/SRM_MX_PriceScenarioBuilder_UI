...
export class LineChartComponent implements OnInit, OnChanges {
  ...
  constructor(private api: ApiService, private priceScenarioService: PriceScenarioService, private excel: ExcelServicesService,) {
  ...
  public downloadE() {
    if (this.isFilterApply) {
      this.chartData = this.totalSelectedValues;
    } else {
     this.chartData = this.simulated;
    }
    ...
    allChartData[0].percentage_change.volume_in_tonnes = this.chartData.percent_change.tonnes;
    allChartData[0].percentage_change["rsv_w/o_vat"] = this.chartData.percent_change.rsv;
    allChartData[0].percentage_change["customer_margin"]= this.chartData.percent_change.rp;
    allChartData[0].percentage_change["lsv"] = this.chartData.percent_change.lsv;
    allChartData[0].percentage_change["trade_expense"] = this.chartData.percent_change.te;
    allChartData[0].percentage_change["net_sales_value"] = this.chartData.percent_change.nsv;
    allChartData[0].percentage_change["mars_mac"]= this.chartData.percent_change.mac;
    allChartData[0].percentage_change["cogs"]= this.chartData.percent_change.cogs;

    allChartData[0].absolute_change.volume_in_tonnes = this.chartData.absolute_change.tonnes;
    allChartData[0].absolute_change["rsv_w/o_vat"] = this.chartData.absolute_change.rsv;
    allChartData[0].absolute_change["customer_margin"]= this.chartData.absolute_change.rp;
    allChartData[0].absolute_change["lsv"] = this.chartData.absolute_change.lsv;
    allChartData[0].absolute_change["trade_expense"] = this.chartData.absolute_change.te;
    allChartData[0].absolute_change["net_sales_value"] = this.chartData.absolute_change.nsv;
    allChartData[0].absolute_change["mars_mac"]= this.chartData.absolute_change.mac;
    allChartData[0].absolute_change["cogs"]= this.chartData.absolute_change.cogs;

    allChartData[0].data.volume_in_tonnes.simulated = this.chartData.simulated.tonnes;
    allChartData[0].data.volume_in_tonnes.base = this.chartData.current.tonnes;

    allChartData[0].data["rsv_w/o_vat"]["simulated"] = this.chartData.simulated.rsv;
    allChartData[0].data["rsv_w/o_vat"]["base"] = this.chartData.current.rsv;

    allChartData[0].data["customer_margin"]["simulated"] = this.chartData.simulated.rp;
    allChartData[0].data["customer_margin"]["base"] = this.chartData.current.rp;

    allChartData[0].data["lsv"]["simulated"] = this.chartData.simulated.lsv;
    allChartData[0].data["lsv"]["base"] = this.chartData.current.lsv;

    allChartData[0].data["trade_expense"]["simulated"] = this.chartData.simulated.te;
    allChartData[0].data["trade_expense"]["base"] = this.chartData.current.te;


    allChartData[0].data["net_sales_value"]["simulated"] = this.chartData.simulated.nsv;
    allChartData[0].data["net_sales_value"]["base"] = this.chartData.current.nsv;

    allChartData[0].data["mars_mac"]["simulated"] = this.chartData.simulated.mac;
    allChartData[0].data["mars_mac"]["base"] = this.chartData.current.mac;

    allChartData[0].data["cogs"]["simulated"] = this.chartData.simulated.cogs;
    allChartData[0].data["cogs"]["base"] = this.chartData.current.cogs;

    this.api.getSummaryExcel(allChartData,"dashboard").subscribe(data=>{
      // console.log(data)
