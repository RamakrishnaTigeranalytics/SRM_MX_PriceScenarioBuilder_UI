...
export class NewUnit extends UnitModel {
  ...
  incremental_te: any;
  cogs: number;
  incremental_cogs: number;
  incremental_unit: any;
  incremental_nsv: number;
  incremental_gsv: number;
  incremental_mac: number;
  incremental_gmac: number;
  gmac_roi: number;
  mac_roi: number;
  lift: number;
  ...
  updateValues() {
    ...
    this.gmac_lsv_per_unit = this.list_price - this.mars_cogs_per_unit;

    this.mars_cogs_per_unit = this.cogs;
      
    this.incremental_cogs = this.incremental_unit * this.mars_cogs_per_unit ;
    this.incremental_gsv = this.incremental_unit * this.list_price;
    this.incremental_nsv = this.incremental_gsv - this.trade_expense;
    this.incremental_mac = this.incremental_nsv - this.incremental_cogs ;
    this.incremental_gmac = this.incremental_gsv- this.incremental_cogs ;
    this.gmac_roi = this.incremental_gmac / this.trade_expense;
    this.mac_roi = this.incremental_mac/ this.trade_expense;
    ...
    this.te_per_units = this.trade_expense / this.base_units;
    ...
    this.retailer_margin_percent_of_rsp =
      this.retailer_margin/this.total_lsv;

    this.lift = this.incremental_unit / this.base_units;
